...
awesome_list = List.create!(name: 'Awesome')
bouh_c_nul = List.create!(name: "bouh c'est nul")

Bookmark.create!(list: awesome_list, movie: redemption, comment: "wowwwwww")
Bookmark.create!(list: bouh_c_nul, movie: titanic, comment: "ouais bof")
